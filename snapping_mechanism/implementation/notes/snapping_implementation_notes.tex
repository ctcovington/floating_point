...
The notation above should not be taken literally, as 0 has a special IEEE representation (all 0s) that does not quite follow the standard formula. We present the standard formally for the sake of consistency and comparison with the earlier cases. \newline
...
\[ \left( \frac{1 + 12B\eta}{\delta} + 2\eta \right)\text{-DP} \]
...
Because we have rescaled our function to $\Delta f = 1$, this is equivalent to
