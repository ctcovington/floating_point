...
% Further, we will also ensure that $B$ is a multiple of $\Lambda$.\footnote{Thanks to Ira for this suggestion.}
% This is necessary for some of the analysis below to hold.
% At a later date, we may need to ensure only that $B$ is a multiple of $\frac{\Lambda}{2}$,
% but it was cleaner to assume it a multiple of $\Lambda$ for now. \newline
