...
Then:
\begin{align}
	               \mathbb{P} \big( clamp_B\left( \lfloor f(D) + Y' \rceil_{\Lambda} \right) = -B \big) \nonumber &= \hspace{5pt} \mathbb{P} \big( \lfloor f(D) + Y' \rceil_{\Lambda} < -B \big) \nonumber \\
