...
I think that if we did this, we could likely not give a post-hoc accuracy guarantee
...
% \subsection{More detail on choosing $B$}
% Up until this point, we have simply assumed that we have some $B$ such that $B > f(D)$.
