...
How exactly we will attempt to address this problem is a work in progress.

\subsubsection{Attempt 1: $P(\text{clamping bound binds})$}
\label{subsubsec:p_clamp_bound_binds}
Let $B'$ be the largest possible value of the statistic, conditional on the data bounds provided
by the user. One approach, adapted from a suggestion by Victor Balcer, is to set
